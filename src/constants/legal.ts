...
- A Maestra oferece: (i) **desbloqueio de Perfil de Artista** mediante **pagamento único**; e (ii) **Assinatura PRO** recorrente (mensal ou anual).
...
- Você nos concede uma **licença limitada, não exclusiva e revogável**, unicamente para hospedar, processar, exibir e operar os recursos da Plataforma em seu benefício, inclusive para gerar as análises e sugestões da Nyta.
...
- As saídas da Nyta são **sugestões automatizadas** e **podem conter erros, imprecisões ou informações desatualizadas**. Elas **não constituem aconselhamento profissional** e **não garantem resultado**.
- **As decisões são sempre suas.** Confira informações relevantes antes de agir.
...
Mantemos seus dados **enquanto a conta estiver ativa** e pelo prazo necessário ao cumprimento das finalidades e de **obrigações legais** (por exemplo, guarda de registros fiscais e de acesso). Encerrada a relação, os dados são eliminados ou anonimizados, ressalvadas as hipóteses de guarda obrigatória previstas em lei.
...
Você pode, a qualquer tempo: confirmar a existência de tratamento; **acessar** seus dados; **corrigir** dados incompletos ou desatualizados; solicitar **anonimização, bloqueio ou eliminação**; requerer **portabilidade**; obter informação sobre **compartilhamentos**; e **revogar consentimento**. Para exercer, escreva para **maestra@musicrioacademy.com.br**. A **exclusão da conta** pode ser solicitada nas Configurações; o pedido é registrado, a assinatura ativa é cancelada e a eliminação é processada, ressalvada a guarda legal obrigatória.
...
A Nyta gera sugestões e análises automatizadas a partir dos dados do Perfil de Artista. Essas saídas têm caráter **consultivo**; as decisões são do Usuário. Você pode solicitar informações sobre esse tratamento pelo canal do Encarregado.
