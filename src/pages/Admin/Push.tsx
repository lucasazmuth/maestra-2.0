...
const styles: Record<string, CSSProperties> = {
  ...
  sub: { color: '#7c8da8', fontSize: 14, lineHeight: 1.5, margin: 0 },
  panel: { background: '#ffffff', border: '1px solid #e3eaf3', borderRadius: 12, padding: 20 },
  label: { display: 'block', color: '#2c3f63', fontSize: 13, fontWeight: 700, margin: '0 0 7px' },
  field: { width: '100%', marginBottom: 18 },
  counter: { float: 'right', color: '#93a4c0', fontWeight: 400 },
  hint: { color: '#7c8da8', fontWeight: 400 },
