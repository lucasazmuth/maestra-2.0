...
export const SwotSummary: FC<{ swot?: SwotAnalysis }> = ({ swot }) => (
  <>
    ...
    <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
      <StatBox label='Forças' value={swot?.strengths?.length || 0} color='#9A4FD1' />
  ...
  return (
    <div style={{ background: '#181818', borderRadius: 12, padding: 20, marginBottom: 24, border: '1px solid #282828' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
        <FaSpotify color='#9A4FD1' size={22} />
      ...
      {!linking ? (
        <button
          ...
          style={{ background: '#9A4FD1', border: 'none', color: '#FFFFFF', padding: '8px 20px', borderRadius: 9999, cursor: 'pointer', fontWeight: 700, fontSize: 13 }}
        >
          Buscar no Spotify
        </button>
      ) : (
