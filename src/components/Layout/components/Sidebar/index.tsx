...
import { FiPlus, FiLock, FiDatabase, FiChevronLeft, FiTag, FiUsers, FiBarChart2, FiBell, FiStar, FiKey } from 'react-icons/fi';
import {
  DashboardIcon,
  DiagnosticoIcon,
  PlanejamentoIcon,
      ...
      {isAdmin && (
        <>
          ...
          <NavItem
            ...
            label="Pass Access"
            collapsed={collapsed}
            active={location.pathname === '/admin/pass-access'}
            onClick={() => navigate('/admin/pass-access')}
          />
          <NavItem
            icon={<FiUsers />}
            label="Usuários"
          ...
          <NavItem
            ...
            label="Enviar push"
            collapsed={collapsed}
            active={location.pathname === '/admin/push'}
