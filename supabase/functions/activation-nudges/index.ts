...
const B: NudgeSpec[] = [
  {
    ...
    title: (a) => `O plano do ${a} tá a um passo`,
    ...
    subject: (a) => `O plano do ${a} tá a um passo`,
    emailBody: (a) => `Você rodou o Diagnóstico REAL do ${a}. O próximo passo é o planejamento estratégico com a Nyta: metas, estratégias e cronograma. Acesso vitalício, num pagamento único.`,
    ctaLabel: "Liberar o planejamento", ctaPath: (id) => `/artists/${id}/desbloquear`,
  },
  {
    code: "B2", minDays: 6, type: "info",
    title: (a) => `Não deixa o ${a} parado`,
    message: (a) => `Diagnóstico sem plano é só diagnóstico. Libere o planejamento e a Nyta monta com você as estratégias pra fazer a carreira do ${a} andar de verdade.`,
    link: (id) => `/artists/${id}/desbloquear`,
    subject: (a) => `Não deixa o ${a} parado`,
    emailBody: (a) => `Diagnóstico sem plano é só diagnóstico. Libere o planejamento e a Nyta monta com você as estratégias pra fazer a carreira do ${a} andar de verdade.`,
...
const C: NudgeSpec[] = [
  {
    ...
    title: (a) => `Seu planejamento do ${a} tá pela metade`,
    ...
    subject: (a) => `Continue o planejamento do ${a}`,
    emailBody: (a) => `Você deu o start no planejamento do ${a}, mas ele ainda não está completo. Volta lá e conclui com a Nyta. É onde metas e cronograma ganham vida.`,
    ctaLabel: "Continuar de onde parei", ctaPath: (id) => `/artists/${id}/wizard`,
  },
  {
    code: "C2", minDays: 6, type: "info",
    title: (a) => `Falta pouco pro plano do ${a}`,
    message: () => "Seu plano de ação está quase pronto. Reserve alguns minutinhos e finalize com a Nyta. Depois é só executar.",
    link: (id) => `/artists/${id}/wizard`,
    subject: (a) => `Falta pouco pro plano do ${a}`,
