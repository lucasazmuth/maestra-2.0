import { flex } from '../wizard/dados';
import type { ArtistGender } from '../interfaces/maestra';

// A VOZ da Nyta — a inteligência da Maestra.
//
// As falas são templadas (custo zero por turno) e seguem o tom do método (Doc 1): direta com
// firmeza carinhosa, empoderadora, "a gente" com naturalidade. A IA gera só o conteúdo
// estratégico (visão/missão montadas, objetivos, estratégias); tudo que ela DIZ está aqui.
//
// Mora no núcleo porque as duas superfícies conduzem a MESMA conversa: uma segunda cópia das
// falas seria uma segunda Nyta, e ninguém perceberia até alguém comparar as duas telas.
